...
function get20s(arr) {
  for (let i = 0; i < arr.length; i++) {
    let num = arr[i].years.split(' - ');
    let numIntOne = parseInt(num[0]);
    let numIntTwo = parseInt(num[1]);
    if (numIntOne >= 1900 && numIntTwo <= 2000) {
...
// , myname, myyears, mygenre, mynationality, mybio
